...
description: "10-stage orchestrator: research → write → integrity check → review → revise → re-review → re-revise → final integrity → finalize. Coordinates deep-research, academic-paper, and academic-paper-reviewer with mandatory integrity gates (2.5/4.5)."
---
